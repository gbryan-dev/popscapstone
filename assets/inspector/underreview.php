...
<html lang="en">
 ...
 <style>
     ...
     .adjustsmfontmobile { font-size: 18px !important }
     }
...
<div class="col-md-12">
    ...
    <h5 class="card-title adjustsmfontmobile" style="margin: auto;font-size: 23px;">Under Review Application Permits</h5>
</div>
    ...
    <script>
function loadApplications(status = 'Under Review') {
...
// Initial load
loadApplications('Under Review');

// Auto-refresh every second
setInterval(() => loadApplications('Under Review'), 1000);
</script>
