...
<div class="col-md-8">
    ...
    <h5 class="card-title" style="margin: 0;">Latest Applications</h5>
    <span class="seemorebtn" onclick="window.location.href='pending'">See More</span>
</div>
...
<div class="col-md-4">
    ...
    <span class="seemorebtn" style="margin-top:-15px" onclick="window.location.href='clients'">See More</span>
</div>
