...
<div style="display: flex; width: 100%; flex-direction: column; align-items: center;text-align: center;">
    <h5 class="card-title" style="margin: auto;font-size: 23px;">Rejected Application Permits</h5>
    ...
    <script>
function loadApplications(status = 'Rejected') {
...
setInterval(() => loadApplications('Rejected'), 1000);
</script>
