...
<div class="lime-sidebar" >
            <div class="lime-sidebar-inner slimscroll">
                <ul class="accordion-menu">
                    ...
                    <li>
                        <a href="index" ><i class="material-icons">dashboard</i>Dashboard</a>
                    </li>

                   
                    <li>
                        <a ><i class="material-icons">app_registration</i>Permits<i class="material-icons has-sub-menu">keyboard_arrow_left</i></a>
                        <ul class="sub-menu">
    <li><a href="all">All Permits</a></li>
    <li><a href="pending">Pending</a></li>
    <li><a href="underreview">Under Review</a></li>
    <li><a href="endorsed">Endorsed to Director</a></li>
    <li><a href="issued">Permit Issued</a></li>
    <li><a href="rejected">Rejected</a></li>
                    ...
                    <li>
                        <a href="clients"><i class="material-icons">groups</i>Clients</a>
                        
                    </li>
                    
                    <li>
                        <a href="map"><i class="material-icons">map</i>Activity Map</a>
                    </li>
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        document.querySelectorAll(".lime-sidebar a[href]").forEach(function (link) {
            const linkHref = link.getAttribute("href");

            if (linkHref === currentPage) {
                // Add 'active' class to the <a> tag only
                link.classList.add("active");
                link.style.color = '#E85252';

                // If inside a sub-menu, open its parent <li>
                const subMenu = link.closest("ul.sub-menu");
                if (subMenu) {
                    const mainParentLi = subMenu.closest("li");
                    const mainParentLiUl = subMenu.closest("li ul");
                    if (mainParentLi) {
                        mainParentLi.classList.add("open");
                        mainParentLiUl.style.display = 'block'
                        mainParentLiUl.style.color = '#E85252';
                    }
                }
            }
        });
