...
<div class="col-md-12">
    ...
    <h5 class="card-title" style="margin: auto;font-size: 23px;">Pending Application Permits</h5>
    ...
    <script>
function loadApplications(status = 'Pending') {
...
setInterval(() => loadApplications('Pending'), 1000);
</script>
