...
if ($result->num_rows === 0) {
    die("No fireworks display permit found for Application ID: " . htmlspecialchars($application_id) . 
        "<br><br>Valid Application IDs with permits: 2, 4, 6, 9, 11, 15, 16, 17, 37");
}
        ...
        <div class="modal2" onclick="event.stopPropagation()">
            <div class="boxcon" id="successendorsed_confetti">
                <div>
                    ...
                    <h4 style="margin-top: 15px;margin-bottom: 0px;color:#0f2c5a">Successfully Endorsed to Director!</h4>
                    <p  style="color:red;">CSG | Philippine National Police</p>
                    <p>
                        This permit has been successfully endorsed to the Director for final review and approval. The endorsement process has been completed.
                    </p>
...
renderSvgTextLineWrap("text868", apply_date, 455,20);
   ...
   <?php if ($status == 'Endorsed To Director'): ?>
          ...
          <div style="color:#19E915;margin-top: 30px;">This permit is endorsed to director.</div>
      <?php endif; ?>                                
...
<div class="d-flex gap-2" style="justify-content: center;margin-top: 20px;margin-bottom:300px;font-family: 'Poppins';">
    ...
    <!-- Edit Button -->
      ...
      <?php if ($status != 'Endorsed To Director' && $status != 'Permit Issued'): ?>
          
    <!-- Endorsed to Director Button onclick="endorsetodirector('<?php echo $application_id; ?>')"-->
    <button type="button" onclick="endorsetodirector('<?php echo $application_id; ?>', '<?php echo $ref_id; ?>', '<?php echo $client_id; ?>')"  class="btn" style="display:flex;background: #19E915 !important;color: white !important;">
             Endorse to Director
    </button>
     <?php endif; ?>
...
function endorsetodirector(appID, ref_id, client_id) {
    ...
    fetch('api/endorse_to_director.php', {
        method: 'POST',
