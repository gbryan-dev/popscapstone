...
<div style="text-align: center; margin: 20px 0; padding: 10px;">
    <button onclick="downloadPermitAsImage()" style="
    ...
    " onmouseover="this.style.backgroundColor='#0f2c5a'" 
       onmouseout="this.style.backgroundColor='#19E915'">
...
<script>
async function downloadPermitAsImage() {
    ...
    canvas.width = 793.76 * scale;
    canvas.height = 1122.56 * scale;
    ...
    img.onload = async function() {
        ...
        const pdf = new jsPDF({
            ...
            unit: 'pt',
            format: [793.76, 1122.56]
        });
        
        pdf.addImage(imgData, 'JPEG', 0, 0, 793.76, 1122.56);
        pdf.save('Permit_Issued_<?php echo $ref_id; ?>.pdf');
